...
import {Segundas} from "./SegundasEspecialidadesData"
...
export const SegundasEspecialidades = () => {
  const [searchValue, setSearchValue] = useState("");
  const [isZoomed, setIsZoomed] = useState(false);
  const [filteredItems, setFilteredItems] = useState(Segundas); 
  ...
  const filterItemsByName = (search) => {
    const updatedItems = Segundas.filter(
      (item) =>
        item.category === "segunda" && removeAccents(item.maestria).includes(removeAccents(search))
    );
    ...
    <>
      <div className="page-heading-maestrias">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 maestrias-banner">
              <h2>Segundas Especialidades</h2>
              <span className="">
                    ...
                    <div className="maestrias-item d-flex flex-column h-100">
                      ...
                      <div className="contenido-abajo" style={{ maxHeight: "350px", overflowY: "auto" }}>
                        ...
                        <a href={item.link} className="mt-auto align-bottom">
                          <button className="btn-maestriasi">Mas Información</button>
                        </a>
                      </div>
                    </div>
                  </Zoom>
